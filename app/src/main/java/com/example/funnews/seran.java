...
public class seran extends AppCompatActivity {
    ...
    final Handler handler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            if (msg.what == 1) {
                ...
                Intent intent = new Intent(seran.this, query.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.serani);

        //setAnimation();
        setStatusBar();
        Intent intent = this.getIntent();
        querry = intent.getStringExtra("querry");
        thread.start();
